...
namespace FMOD
{
    ...
    */
    ...
    {        
        public static RESULT System_Create(ref System system)
        {
            ...
            result = Interface.FMOD_System_Create(ref systemraw);
            if (result != RESULT.OK)
            {
                return result;
            }
    ...
    public class Memory
    {
        ...
        {
            return Interface.FMOD_Memory_GetStats(ref currentalloced, ref maxalloced, 1);
        }
    
        public static RESULT GetStats(ref int currentalloced, ref int maxalloced, bool blocking)
        {
            return Interface.FMOD_Memory_GetStats(ref currentalloced, ref maxalloced, (blocking ? 1 : 0));
        }
    ...
    */
    public class System
    {
        ...
        {
            return Interface.FMOD_System_Release(systemraw);
        }
        ...
        {
            return Interface.FMOD_System_SetOutput(systemraw, output);
        }
        public RESULT getOutput              (ref OUTPUTTYPE output)
        {
            return Interface.FMOD_System_GetOutput(systemraw, ref output);
        }
        public RESULT getNumDrivers          (ref int numdrivers)
        {
            return Interface.FMOD_System_GetNumDrivers(systemraw, ref numdrivers);
        }
        public RESULT getDriverInfo          (int id, [MarshalAs(UnmanagedType.LPWStr)]StringBuilder name, int namelen, ref GUID guid)
        {
            ...
            return Interface.FMOD_System_GetDriverInfoW(systemraw, id, name, namelen, ref guid);
        }
        public RESULT getDriverCaps          (int id, ref CAPS caps, ref int controlpaneloutputrate, ref SPEAKERMODE controlpanelspeakermode)
        {
            return Interface.FMOD_System_GetDriverCaps(systemraw, id, ref caps, ref controlpaneloutputrate, ref controlpanelspeakermode);
        }
        public RESULT setDriver              (int driver)
        {
            return Interface.FMOD_System_SetDriver(systemraw, driver);
        }
        public RESULT getDriver              (ref int driver)
        {
            return Interface.FMOD_System_GetDriver(systemraw, ref driver);
        }
        public RESULT setHardwareChannels    (int numhardwarechannels)
        {
            return Interface.FMOD_System_SetHardwareChannels(systemraw, numhardwarechannels);
        }
        public RESULT setSoftwareChannels    (int numsoftwarechannels)
        {
            return Interface.FMOD_System_SetSoftwareChannels(systemraw, numsoftwarechannels);
        }
        public RESULT getSoftwareChannels    (ref int numsoftwarechannels)
        {
            return Interface.FMOD_System_GetSoftwareChannels(systemraw, ref numsoftwarechannels);
        }
        ...
        {
            return Interface.FMOD_System_SetSoftwareFormat(systemraw, samplerate, format, numoutputchannels, maxinputchannels, resamplemethod);
        }
        ...
        {
            return Interface.FMOD_System_GetSoftwareFormat(systemraw, ref samplerate, ref format, ref numoutputchannels, ref maxinputchannels, ref resamplemethod, ref bits);
        }
        public RESULT setDSPBufferSize       (uint bufferlength, int numbuffers)
        {
            return Interface.FMOD_System_SetDSPBufferSize(systemraw, bufferlength, numbuffers);
        }
        public RESULT getDSPBufferSize       (ref uint bufferlength, ref int numbuffers)
        {
            return Interface.FMOD_System_GetDSPBufferSize(systemraw, ref bufferlength, ref numbuffers);
        }
        ...
        {
            return Interface.FMOD_System_SetFileSystem(systemraw, useropen, userclose, userread, userseek, userasyncread, userasynccancel, blockalign);
        }
        ...
        {
            return Interface.FMOD_System_AttachFileSystem(systemraw, useropen, userclose, userread, userseek);
        }
        public RESULT setAdvancedSettings    (ref ADVANCEDSETTINGS settings)
        {
            return Interface.FMOD_System_SetAdvancedSettings(systemraw, ref settings);
        }
        public RESULT getAdvancedSettings    (ref ADVANCEDSETTINGS settings)
        {
            return Interface.FMOD_System_GetAdvancedSettings(systemraw, ref settings);
        }
        public RESULT setSpeakerMode         (SPEAKERMODE speakermode)
        {
            return Interface.FMOD_System_SetSpeakerMode(systemraw, speakermode);
        }
        public RESULT getSpeakerMode         (ref SPEAKERMODE speakermode)
        {
            return Interface.FMOD_System_GetSpeakerMode(systemraw, ref speakermode);
        }
        public RESULT setCallback            (SYSTEM_CALLBACK callback)
        {
            return Interface.FMOD_System_SetCallback(systemraw, callback);
        }
                         
        // Plug-in support
        public RESULT setPluginPath          (string path)
        {
            return Interface.FMOD_System_SetPluginPath(systemraw, path);
        }
        public RESULT loadPlugin             (string filename, ref uint handle, uint priority)
        {
            return Interface.FMOD_System_LoadPlugin(systemraw, filename, ref handle, priority);
        }
        public RESULT unloadPlugin           (uint handle)
        {
            return Interface.FMOD_System_UnloadPlugin(systemraw, handle);
        }
        public RESULT getNumPlugins          (PLUGINTYPE plugintype, ref int numplugins)
        {
            return Interface.FMOD_System_GetNumPlugins(systemraw, plugintype, ref numplugins);
        }
        public RESULT getPluginHandle        (PLUGINTYPE plugintype, int index, ref uint handle)
        {
            return Interface.FMOD_System_GetPluginHandle(systemraw, plugintype, index, ref handle);
        }
        public RESULT getPluginInfo          (uint handle, ref PLUGINTYPE plugintype, StringBuilder name, int namelen, ref uint version)
        {
            return Interface.FMOD_System_GetPluginInfo(systemraw, handle, ref plugintype, name, namelen, ref version);
        }

        public RESULT setOutputByPlugin      (uint handle)
        {
            return Interface.FMOD_System_SetOutputByPlugin(systemraw, handle);
        }
        public RESULT getOutputByPlugin      (ref uint handle)
        {
            return Interface.FMOD_System_GetOutputByPlugin(systemraw, ref handle);
        }
        public RESULT createDSPByPlugin      (uint handle, ref IntPtr dsp)
        {
            return Interface.FMOD_System_CreateDSPByPlugin(systemraw, handle, ref dsp);
        }
        public RESULT createCodec            (IntPtr description, uint priority)
        {
            return Interface.FMOD_System_CreateCodec(systemraw, description, priority);
        }
        ...
        {
            return Interface.FMOD_System_Init(systemraw, maxchannels, flags, extradriverdata);
        }
        public RESULT close                  ()
        {
            return Interface.FMOD_System_Close(systemraw);
        }
        ...
        {
            return Interface.FMOD_System_Update(systemraw);
        }

        public RESULT set3DSettings          (float dopplerscale, float distancefactor, float rolloffscale)
        {
            return Interface.FMOD_System_Set3DSettings(systemraw, dopplerscale, distancefactor, rolloffscale);
        }
        public RESULT get3DSettings          (ref float dopplerscale, ref float distancefactor, ref float rolloffscale)
        {
            return Interface.FMOD_System_Get3DSettings(systemraw, ref dopplerscale, ref distancefactor, ref rolloffscale);
        }
        public RESULT set3DNumListeners      (int numlisteners)
        {
            return Interface.FMOD_System_Set3DNumListeners(systemraw, numlisteners);
        }
        public RESULT get3DNumListeners      (ref int numlisteners)
        {
            return Interface.FMOD_System_Get3DNumListeners(systemraw, ref numlisteners);
        }
        public RESULT set3DListenerAttributes(int listener, ref VECTOR pos, ref VECTOR vel, ref VECTOR forward, ref VECTOR up)
        {
            return Interface.FMOD_System_Set3DListenerAttributes(systemraw, listener, ref pos, ref vel, ref forward, ref up);
        }
        public RESULT get3DListenerAttributes(int listener, ref VECTOR pos, ref VECTOR vel, ref VECTOR forward, ref VECTOR up)
        {
            return Interface.FMOD_System_Get3DListenerAttributes(systemraw, listener, ref pos, ref vel, ref forward, ref up);
        }

        public RESULT set3DRolloffCallback   (CB_3D_ROLLOFFCALLBACK callback)
        {
            return  Interface.FMOD_System_Set3DRolloffCallback   (systemraw, callback);
        }
        public RESULT set3DSpeakerPosition     (SPEAKER speaker, float x, float y, bool active)
        {
            return Interface.FMOD_System_Set3DSpeakerPosition(systemraw, speaker, x, y, (active ? 1 : 0));
        }
        public RESULT get3DSpeakerPosition     (SPEAKER speaker, ref float x, ref float y, ref bool active)
        {
            ...
            result = Interface.FMOD_System_Get3DSpeakerPosition(systemraw, speaker, ref x, ref y, ref isactive);
        ...
        {
            return Interface.FMOD_System_SetStreamBufferSize(systemraw, filebuffersize, filebuffersizetype);
        }
        public RESULT getStreamBufferSize    (ref uint filebuffersize, ref TIMEUNIT filebuffersizetype)
        {
            return Interface.FMOD_System_GetStreamBufferSize(systemraw, ref filebuffersize, ref filebuffersizetype);
        }
        ...
        {
            return Interface.FMOD_System_GetVersion(systemraw, ref version);
        }
        public RESULT getOutputHandle        (ref IntPtr handle)
        {
            return Interface.FMOD_System_GetOutputHandle(systemraw, ref handle);
        }
        public RESULT getChannelsPlaying     (ref int channels)
        {
            return Interface.FMOD_System_GetChannelsPlaying(systemraw, ref channels);
        }
        public RESULT getHardwareChannels    (ref int numhardwarechannels)
        {
            return Interface.FMOD_System_GetHardwareChannels(systemraw, ref numhardwarechannels);
        }
        public RESULT getCPUUsage            (ref float dsp, ref float stream, ref float geometry, ref float update, ref float total)
        {
            return Interface.FMOD_System_GetCPUUsage(systemraw, ref dsp, ref stream, ref geometry, ref update, ref total);
        }
        public RESULT getSoundRAM            (ref int currentalloced, ref int maxalloced, ref int total)
        {
            return Interface.FMOD_System_GetSoundRAM(systemraw, ref currentalloced, ref maxalloced, ref total);
        }
        public RESULT getNumCDROMDrives      (ref int numdrives)
        {
            return Interface.FMOD_System_GetNumCDROMDrives(systemraw, ref numdrives);
        }
        ...
        {
            return Interface.FMOD_System_GetCDROMDriveName(systemraw, drive, drivename, drivenamelen, scsiname, scsinamelen, devicename, devicenamelen);
        }
        public RESULT getSpectrum            (float[] spectrumarray, int numvalues, int channeloffset, DSP_FFT_WINDOW windowtype)
        {
            return Interface.FMOD_System_GetSpectrum(systemraw, spectrumarray, numvalues, channeloffset, windowtype);
        }
        public RESULT getWaveData            (float[] wavearray, int numvalues, int channeloffset)
        {
            return Interface.FMOD_System_GetWaveData(systemraw, wavearray, numvalues, channeloffset);
        }
        ...
        public RESULT createSound            (string name_or_data, MODE mode, ref CREATESOUNDEXINFO exinfo, ref Sound sound)
        {
            ...
            try
            {
                result = Interface.FMOD_System_CreateSound(systemraw, name_or_data, mode, ref exinfo, ref soundraw);
            }
            catch
            {
        ...
        public RESULT createSound            (byte[] data, MODE mode, ref CREATESOUNDEXINFO exinfo, ref Sound sound)
        {
            ...
            try
            {
                result = Interface.FMOD_System_CreateSound(systemraw, data, mode, ref exinfo, ref soundraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT createSound            (string name_or_data, MODE mode, ref Sound sound)
        {
            ...
            try
            {
                result = Interface.FMOD_System_CreateSound(systemraw, name_or_data, mode, 0, ref soundraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT createStream            (string name_or_data, MODE mode, ref CREATESOUNDEXINFO exinfo, ref Sound sound)
        {
            ...
            try
            {
                result = Interface.FMOD_System_CreateStream(systemraw, name_or_data, mode, ref exinfo, ref soundraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT createStream            (byte[] data, MODE mode, ref CREATESOUNDEXINFO exinfo, ref Sound sound)
        {
            ...
            try
            {
                result = Interface.FMOD_System_CreateStream(systemraw, data, mode, ref exinfo, ref soundraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT createStream            (string name_or_data, MODE mode, ref Sound sound)
        {
            ...
            try
            {
                result = Interface.FMOD_System_CreateStream(systemraw, name_or_data, mode, 0, ref soundraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT createDSP              (ref DSP_DESCRIPTION description, ref DSP dsp)
        {
            ...
            try
            {
                result = Interface.FMOD_System_CreateDSP(systemraw, ref description, ref dspraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT createDSPByType          (DSP_TYPE type, ref DSP dsp)
        {
            ...
            try
            {
                result = Interface.FMOD_System_CreateDSPByType(systemraw, type, ref dspraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT createChannelGroup     (string name, ref ChannelGroup channelgroup)
        {
            ...
            try
            {
                result = Interface.FMOD_System_CreateChannelGroup(systemraw, name, ref channelgroupraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT createSoundGroup       (string name, ref SoundGroup soundgroup)
        {
            ...
            try
            {
                result = Interface.FMOD_System_CreateSoundGroup(systemraw, name, ref soundgroupraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT createReverb           (ref Reverb reverb)
        {
            ...
            try
            {
                result = Interface.FMOD_System_CreateReverb(systemraw, ref reverbraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT playSound              (CHANNELINDEX channelid, Sound sound, bool paused, ref Channel channel)
        {
            ...
            try
            {
                result = Interface.FMOD_System_PlaySound(systemraw, channelid, sound.getRaw(), (paused ? 1 : 0), ref channelraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT playDSP                (CHANNELINDEX channelid, DSP dsp, bool paused, ref Channel channel)
        {
            ...
            try
            {
                result = Interface.FMOD_System_PlayDSP(systemraw, channelid, dsp.getRaw(), (paused ? 1 : 0), ref channelraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT getChannel             (int channelid, ref Channel channel)
        {
            ...
            try
            {
                result = Interface.FMOD_System_GetChannel(systemraw, channelid, ref channelraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT getMasterChannelGroup  (ref ChannelGroup channelgroup)
        {
            ...
            try
            {
                result = Interface.FMOD_System_GetMasterChannelGroup(systemraw, ref channelgroupraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT getMasterSoundGroup    (ref SoundGroup soundgroup)
        {
            ...
            try
            {
                result = Interface.FMOD_System_GetMasterSoundGroup(systemraw, ref soundgroupraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        {
            return Interface.FMOD_System_SetReverbProperties(systemraw, ref prop);
        }
        public RESULT getReverbProperties    (ref REVERB_PROPERTIES prop)
        {
            return Interface.FMOD_System_GetReverbProperties(systemraw, ref prop);
        }
                                        
        public RESULT setReverbAmbientProperties (ref REVERB_PROPERTIES prop)
        {
            return Interface.FMOD_System_SetReverbAmbientProperties(systemraw, ref prop);
        }
        public RESULT getReverbAmbientProperties (ref REVERB_PROPERTIES prop)
        {
            return Interface.FMOD_System_GetReverbAmbientProperties(systemraw, ref prop);
        }
        ...
        public RESULT getDSPHead             (ref DSP dsp)
        {
            ...
            try
            {
                result = Interface.FMOD_System_GetDSPHead(systemraw, ref dspraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT addDSP                 (DSP dsp, ref DSPConnection connection)
        {
            ...
            try
            {
                result = Interface.FMOD_System_AddDSP(systemraw, dsp.getRaw(), ref dspconnectionraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        {
            return Interface.FMOD_System_LockDSP(systemraw);
        }
        public RESULT unlockDSP          ()
        {
            return Interface.FMOD_System_UnlockDSP(systemraw);
        }
        public RESULT getDSPClock          (ref uint hi, ref uint lo)
        {
            return Interface.FMOD_System_GetDSPClock   (systemraw, ref hi, ref lo);
        }
        ...
        {
            return Interface.FMOD_System_GetRecordNumDrivers(systemraw, ref numdrivers);
        }
        public RESULT getRecordDriverInfo    (int id, [MarshalAs(UnmanagedType.LPWStr)]StringBuilder name, int namelen, ref GUID guid)
        {
            //use multibyte version
            return Interface.FMOD_System_GetRecordDriverInfoW(systemraw, id, name, namelen, ref guid);
        }
        public RESULT getRecordDriverCaps    (int id, ref CAPS caps, ref int minfrequency, ref int maxfrequency)
        {
            return Interface.FMOD_System_GetRecordDriverCaps(systemraw, id, ref caps, ref minfrequency, ref maxfrequency);
        }
        public RESULT getRecordPosition      (int id, ref uint position)
        {
            return Interface.FMOD_System_GetRecordPosition(systemraw, id, ref position);
        }

        public RESULT recordStart            (int id, Sound sound, bool loop)
        {
            return Interface.FMOD_System_RecordStart(systemraw, id, sound.getRaw(), (loop ? 1 : 0));
        }
        public RESULT recordStop             (int id)
        {
            return Interface.FMOD_System_RecordStop(systemraw, id);
        }
        public RESULT isRecording            (int id, ref bool recording)
        {
            ...
            result = Interface.FMOD_System_IsRecording(systemraw, id, ref r);
        ...
        public RESULT createGeometry         (int maxpolygons, int maxvertices, ref Geometry geometry)
        {
            ...
            try
            {
                result = Interface.FMOD_System_CreateGeometry(systemraw, maxpolygons, maxvertices, ref geometryraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        {
            return Interface.FMOD_System_SetGeometrySettings(systemraw, maxworldsize);
        }
        public RESULT getGeometrySettings    (ref float maxworldsize)
        {
            return Interface.FMOD_System_GetGeometrySettings(systemraw, ref maxworldsize);
        }
        public RESULT loadGeometry(IntPtr data, int datasize, ref Geometry geometry)
        {
            ...
            try
            {
                result = Interface.FMOD_System_LoadGeometry(systemraw, data, datasize, ref geometryraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        {
            return Interface.FMOD_System_GetGeometryOcclusion(systemraw, ref listener, ref source, ref direct, ref reverb);
        }
  
        // Network functions
        public RESULT setNetworkProxy               (string proxy)
        {
            return Interface.FMOD_System_SetNetworkProxy(systemraw, proxy);
        }
        public RESULT getNetworkProxy               (StringBuilder proxy, int proxylen)
        {
            return Interface.FMOD_System_GetNetworkProxy(systemraw, proxy, proxylen);
        }
        public RESULT setNetworkTimeout      (int timeout)
        {
            return Interface.FMOD_System_SetNetworkTimeout(systemraw, timeout);
        }
        public RESULT getNetworkTimeout(ref int timeout)
        {
            return Interface.FMOD_System_GetNetworkTimeout(systemraw, ref timeout);
        }
                                     
        // Userdata set/get                         
        public RESULT setUserData            (IntPtr userdata)
        {
            return Interface.FMOD_System_SetUserData(systemraw, userdata);
        }
        public RESULT getUserData            (ref IntPtr userdata)
        {
            return Interface.FMOD_System_GetUserData(systemraw, ref userdata);
        }
        ...
        {
            return Interface.FMOD_System_GetMemoryInfo(systemraw, memorybits, event_memorybits, ref memoryused, ref memoryused_details);
        }
    ...
    */
    public class Sound
    {
        public RESULT release                 ()
        {
            return Interface.FMOD_Sound_Release(soundraw);
        }
        public RESULT getSystemObject         (ref System system)
        {
            ...
            try
            {
                result = Interface.FMOD_Sound_GetSystemObject(soundraw, ref systemraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        {
            return Interface.FMOD_Sound_Lock(soundraw, offset, length, ref ptr1, ref ptr2, ref len1, ref len2);
        }
        public RESULT unlock                  (IntPtr ptr1,  IntPtr ptr2, uint len1, uint len2)
        {
            return Interface.FMOD_Sound_Unlock(soundraw, ptr1, ptr2, len1, len2);
        }
        public RESULT setDefaults             (float frequency, float volume, float pan, int priority)
        {
            return Interface.FMOD_Sound_SetDefaults(soundraw, frequency, volume, pan, priority);
        }
        public RESULT getDefaults             (ref float frequency, ref float volume, ref float pan, ref int priority)
        {
            return Interface.FMOD_Sound_GetDefaults(soundraw, ref frequency, ref volume, ref pan, ref priority);
        }
        public RESULT setVariations           (float frequencyvar, float volumevar, float panvar)
        {
            return Interface.FMOD_Sound_SetVariations(soundraw, frequencyvar, volumevar, panvar);
        }
        public RESULT getVariations           (ref float frequencyvar, ref float volumevar, ref float panvar)
        {
            return Interface.FMOD_Sound_GetVariations(soundraw, ref frequencyvar, ref volumevar, ref panvar); 
        }
        public RESULT set3DMinMaxDistance     (float min, float max)
        {
            return Interface.FMOD_Sound_Set3DMinMaxDistance(soundraw, min, max);
        }
        public RESULT get3DMinMaxDistance     (ref float min, ref float max)
        {
            return Interface.FMOD_Sound_Get3DMinMaxDistance(soundraw, ref min, ref max);
        }
        public RESULT set3DConeSettings       (float insideconeangle, float outsideconeangle, float outsidevolume)
        {
            return Interface.FMOD_Sound_Set3DConeSettings(soundraw, insideconeangle, outsideconeangle, outsidevolume);
        }
        public RESULT get3DConeSettings       (ref float insideconeangle, ref float outsideconeangle, ref float outsidevolume)
        {
            return Interface.FMOD_Sound_Get3DConeSettings(soundraw, ref insideconeangle, ref outsideconeangle, ref outsidevolume);
        }
        public RESULT set3DCustomRolloff      (ref VECTOR points, int numpoints)
        {
            return Interface.FMOD_Sound_Set3DCustomRolloff(soundraw, ref points, numpoints);
        }
        public RESULT get3DCustomRolloff      (ref IntPtr points, ref int numpoints)
        {
            return Interface.FMOD_Sound_Get3DCustomRolloff(soundraw, ref points, ref numpoints);
        }
        public RESULT setSubSound             (int index, Sound subsound)
        {
            IntPtr subsoundraw = subsound.getRaw();

            return Interface.FMOD_Sound_SetSubSound(soundraw, index, subsoundraw);
        }
        public RESULT getSubSound             (int index, ref Sound subsound)
        {
            ...
            try
            {
                result = Interface.FMOD_Sound_GetSubSound(soundraw, index, ref subsoundraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        {
            return Interface.FMOD_Sound_SetSubSoundSentence(soundraw, subsoundlist, numsubsounds);
        }
        public RESULT getName                 (StringBuilder name, int namelen)
        {
            return Interface.FMOD_Sound_GetName(soundraw, name, namelen);
        }
        public RESULT getLength               (ref uint length, TIMEUNIT lengthtype)
        {
            return Interface.FMOD_Sound_GetLength(soundraw, ref length, lengthtype);
        }
        public RESULT getFormat               (ref SOUND_TYPE type, ref SOUND_FORMAT format, ref int channels, ref int bits)
        {
            return Interface.FMOD_Sound_GetFormat(soundraw, ref type, ref format, ref channels, ref bits);
        }
        public RESULT getNumSubSounds         (ref int numsubsounds)
        {
            return Interface.FMOD_Sound_GetNumSubSounds(soundraw, ref numsubsounds);
        }
        public RESULT getNumTags              (ref int numtags, ref int numtagsupdated)
        {
            return Interface.FMOD_Sound_GetNumTags(soundraw, ref numtags, ref numtagsupdated);
        }
        public RESULT getTag                  (string name, int index, ref TAG tag)
        {
            return Interface.FMOD_Sound_GetTag(soundraw, name, index, ref tag);
        }
        public RESULT getOpenState            (ref OPENSTATE openstate, ref uint percentbuffered, ref bool starving, ref bool diskbusy)
        {
            ...
            result = Interface.FMOD_Sound_GetOpenState(soundraw, ref openstate, ref percentbuffered, ref s, ref b);
        ...
        {
            return Interface.FMOD_Sound_ReadData(soundraw, buffer, lenbytes, ref read);
        }
        public RESULT seekData                (uint pcm)
        {
            return Interface.FMOD_Sound_SeekData(soundraw, pcm);
        }


        public RESULT setSoundGroup           (SoundGroup soundgroup)
        {
            return Interface.FMOD_Sound_SetSoundGroup(soundraw, soundgroup.getRaw());
        }
        public RESULT getSoundGroup           (ref SoundGroup soundgroup)
        {
            ...
            try
            {
                result = Interface.FMOD_Sound_GetSoundGroup(soundraw, ref soundgroupraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        {
            return Interface.FMOD_Sound_GetNumSyncPoints(soundraw, ref numsyncpoints);
        }
        public RESULT getSyncPoint            (int index, ref IntPtr point)
        {
            return Interface.FMOD_Sound_GetSyncPoint(soundraw, index, ref point);
        }
        public RESULT getSyncPointInfo        (IntPtr point, StringBuilder name, int namelen, ref uint offset, TIMEUNIT offsettype)
        {
            return Interface.FMOD_Sound_GetSyncPointInfo(soundraw, point, name, namelen, ref offset, offsettype);
        }
        public RESULT addSyncPoint            (uint offset, TIMEUNIT offsettype, string name, ref IntPtr point)
        {
            return Interface.FMOD_Sound_AddSyncPoint(soundraw, offset, offsettype, name, ref point);
        }
        public RESULT deleteSyncPoint         (IntPtr point)
        {
            return Interface.FMOD_Sound_DeleteSyncPoint(soundraw, point);
        }


        public RESULT setMode                 (MODE mode)
        {
            return Interface.FMOD_Sound_SetMode(soundraw, mode);
        }
        public RESULT getMode                 (ref MODE mode)
        {
            return Interface.FMOD_Sound_GetMode(soundraw, ref mode);
        }
        public RESULT setLoopCount            (int loopcount)
        {
            return Interface.FMOD_Sound_SetLoopCount(soundraw, loopcount);
        }
        public RESULT getLoopCount            (ref int loopcount)
        {
            return Interface.FMOD_Sound_GetLoopCount(soundraw, ref loopcount);
        }
        public RESULT setLoopPoints           (uint loopstart, TIMEUNIT loopstarttype, uint loopend, TIMEUNIT loopendtype)
        {
            return Interface.FMOD_Sound_SetLoopPoints(soundraw, loopstart, loopstarttype, loopend, loopendtype);
        }
        public RESULT getLoopPoints           (ref uint loopstart, TIMEUNIT loopstarttype, ref uint loopend, TIMEUNIT loopendtype)
        {
            return Interface.FMOD_Sound_GetLoopPoints(soundraw, ref loopstart, loopstarttype, ref loopend, loopendtype);
        }

        public RESULT getMusicNumChannels       (ref int numchannels)
        {
            return Interface.FMOD_Sound_GetMusicNumChannels(soundraw, ref numchannels);
        }
        public RESULT setMusicChannelVolume     (int channel, float volume)
        {
            return Interface.FMOD_Sound_SetMusicChannelVolume(soundraw, channel, volume);
        }
        public RESULT getMusicChannelVolume     (int channel, ref float volume)
        {
            return Interface.FMOD_Sound_GetMusicChannelVolume(soundraw, channel, ref volume);
        }
        public RESULT setMusicSpeed(float speed)
        {
            return Interface.FMOD_Sound_SetMusicSpeed(soundraw, speed);
        }
        public RESULT getMusicSpeed(ref float speed)
        {
            return Interface.FMOD_Sound_GetMusicSpeed(soundraw, ref speed);
        }

        public RESULT setUserData             (IntPtr userdata)
        {
            return Interface.FMOD_Sound_SetUserData(soundraw, userdata);
        }
        public RESULT getUserData             (ref IntPtr userdata)
        {
            return Interface.FMOD_Sound_GetUserData(soundraw, ref userdata);
        }

        public RESULT getMemoryInfo(uint memorybits, uint event_memorybits, ref uint memoryused, ref MEMORY_USAGE_DETAILS memoryused_details)
        {
            return Interface.FMOD_Sound_GetMemoryInfo(soundraw, memorybits, event_memorybits, ref memoryused, ref memoryused_details);
        }
    ...
    */
    public class Channel
    {
        public RESULT getSystemObject       (ref System system)
        {
            ...
            try
            {
                result = Interface.FMOD_Channel_GetSystemObject(channelraw, ref systemraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT stop                  ()
        {
            return Interface.FMOD_Channel_Stop(channelraw);
        }
        public RESULT setPaused             (bool paused)
        {
            return Interface.FMOD_Channel_SetPaused(channelraw, (paused ? 1 : 0));
        }
        public RESULT getPaused             (ref bool paused)
        {
            ...
            result = Interface.FMOD_Channel_GetPaused(channelraw, ref p);
        ...
        {
            return Interface.FMOD_Channel_SetVolume(channelraw, volume);
        }
        public RESULT getVolume             (ref float volume)
        {
            return Interface.FMOD_Channel_GetVolume(channelraw, ref volume);
        }
        public RESULT setFrequency          (float frequency)
        {
            return Interface.FMOD_Channel_SetFrequency(channelraw, frequency);
        }
        public RESULT getFrequency          (ref float frequency)
        {
            return Interface.FMOD_Channel_GetFrequency(channelraw, ref frequency);
        }
        public RESULT setPan                (float pan)
        {
            return Interface.FMOD_Channel_SetPan(channelraw, pan);
        }
        public RESULT getPan                (ref float pan)
        {
            return Interface.FMOD_Channel_GetPan(channelraw, ref pan);
        }
        public RESULT setDelay              (DELAYTYPE delaytype, uint delayhi, uint delaylo)
        {
            return Interface.FMOD_Channel_SetDelay(channelraw, delaytype, delayhi, delaylo);
        }
        public RESULT getDelay              (DELAYTYPE delaytype, ref uint delayhi, ref uint delaylo)
        {
            return Interface.FMOD_Channel_GetDelay(channelraw, delaytype, ref delayhi, ref delaylo);
        }
        ...
        {
            return Interface.FMOD_Channel_SetSpeakerMix(channelraw, frontleft, frontright, center, lfe, backleft, backright, sideleft, sideright);
        }
        ...
        {
            return Interface.FMOD_Channel_GetSpeakerMix(channelraw, ref frontleft, ref frontright, ref center, ref lfe, ref backleft, ref backright, ref sideleft, ref sideright);
        }
        public RESULT setSpeakerLevels      (SPEAKER speaker, float[] levels, int numlevels)
        {
            return Interface.FMOD_Channel_SetSpeakerLevels(channelraw, speaker, levels, numlevels);
        }
        public RESULT getSpeakerLevels      (SPEAKER speaker, float[] levels, int numlevels)
        {
            return Interface.FMOD_Channel_GetSpeakerLevels(channelraw, speaker, levels, numlevels);
        }
        public RESULT setInputChannelMix    (float[] levels, int numlevels)
        {
            return Interface.FMOD_Channel_SetInputChannelMix(channelraw, levels, numlevels);
        }
        public RESULT getInputChannelMix    (float[] levels, int numlevels)
        {
            return Interface.FMOD_Channel_GetInputChannelMix(channelraw, levels, numlevels);
        }
        public RESULT setMute               (bool mute)
        {
            return Interface.FMOD_Channel_SetMute(channelraw, (mute ? 1 : 0));
        }
        public RESULT getMute               (ref bool mute)
        {
            ...
            result = Interface.FMOD_Channel_GetMute(channelraw, ref m);
        ...
        {
            return Interface.FMOD_Channel_SetPriority(channelraw, priority);
        }
        public RESULT getPriority           (ref int priority)
        {
            return Interface.FMOD_Channel_GetPriority(channelraw, ref priority);
        }
        public RESULT setPosition           (uint position, TIMEUNIT postype)
        {
            return Interface.FMOD_Channel_SetPosition(channelraw, position, postype);
        }
        public RESULT getPosition           (ref uint position, TIMEUNIT postype)
        {
            return Interface.FMOD_Channel_GetPosition(channelraw, ref position, postype);
        }
        
        public RESULT setLowPassGain           (float gain)
        {
            return Interface.FMOD_Channel_SetLowPassGain(channelraw, gain);
        }
        public RESULT getLowPassGain           (ref float gain)
        {
            return Interface.FMOD_Channel_GetLowPassGain(channelraw, ref gain);
        }
        
        public RESULT setReverbProperties   (ref REVERB_CHANNELPROPERTIES prop)
        {
            return Interface.FMOD_Channel_SetReverbProperties(channelraw, ref prop);
        }
        public RESULT getReverbProperties   (ref REVERB_CHANNELPROPERTIES prop)
        {
            return Interface.FMOD_Channel_GetReverbProperties(channelraw, ref prop);
        }
        public RESULT setChannelGroup       (ChannelGroup channelgroup)
        {
            return Interface.FMOD_Channel_SetChannelGroup(channelraw, channelgroup.getRaw());
        }
        public RESULT getChannelGroup        (ref ChannelGroup channelgroup)
        {
            ...
            try
            {
                result = Interface.FMOD_Channel_GetChannelGroup(channelraw, ref channelgroupraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        {
            return Interface.FMOD_Channel_SetCallback(channelraw, callback);
        }


        public RESULT set3DAttributes       (ref VECTOR pos, ref VECTOR vel)
        {
            return Interface.FMOD_Channel_Set3DAttributes(channelraw, ref pos, ref vel);
        }
        public RESULT get3DAttributes       (ref VECTOR pos, ref VECTOR vel)
        {
            return Interface.FMOD_Channel_Get3DAttributes(channelraw, ref pos, ref vel);
        }
        public RESULT set3DMinMaxDistance   (float mindistance, float maxdistance)
        {
            return Interface.FMOD_Channel_Set3DMinMaxDistance(channelraw, mindistance, maxdistance);
        }
        public RESULT get3DMinMaxDistance   (ref float mindistance, ref float maxdistance)
        {
            return Interface.FMOD_Channel_Get3DMinMaxDistance(channelraw, ref mindistance, ref maxdistance);
        }
        public RESULT set3DConeSettings     (float insideconeangle, float outsideconeangle, float outsidevolume)
        {
            return Interface.FMOD_Channel_Set3DConeSettings(channelraw, insideconeangle, outsideconeangle, outsidevolume);
        }
        public RESULT get3DConeSettings     (ref float insideconeangle, ref float outsideconeangle, ref float outsidevolume)
        {
            return Interface.FMOD_Channel_Get3DConeSettings(channelraw, ref insideconeangle, ref outsideconeangle, ref outsidevolume);
        }
        public RESULT set3DConeOrientation  (ref VECTOR orientation)
        {
            return Interface.FMOD_Channel_Set3DConeOrientation(channelraw, ref orientation);
        }
        public RESULT get3DConeOrientation  (ref VECTOR orientation)
        {
            return Interface.FMOD_Channel_Get3DConeOrientation(channelraw, ref orientation);
        }
        public RESULT set3DCustomRolloff    (ref VECTOR points, int numpoints)
        {
            return Interface.FMOD_Channel_Set3DCustomRolloff(channelraw, ref points, numpoints);
        }
        public RESULT get3DCustomRolloff    (ref IntPtr points, ref int numpoints)
        {
            return Interface.FMOD_Channel_Get3DCustomRolloff(channelraw, ref points, ref numpoints);
        }
        public RESULT set3DOcclusion        (float directocclusion, float reverbocclusion)
        {
            return Interface.FMOD_Channel_Set3DOcclusion(channelraw, directocclusion, reverbocclusion);
        }
        public RESULT get3DOcclusion        (ref float directocclusion, ref float reverbocclusion)
        {
            return Interface.FMOD_Channel_Get3DOcclusion(channelraw, ref directocclusion, ref reverbocclusion);
        }
        public RESULT set3DSpread           (float angle)
        {
            return Interface.FMOD_Channel_Set3DSpread(channelraw, angle);
        }
        public RESULT get3DSpread           (ref float angle)
        {
            return Interface.FMOD_Channel_Get3DSpread(channelraw, ref angle);
        }
        public RESULT set3DPanLevel         (float level)
        {
            return Interface.FMOD_Channel_Set3DPanLevel(channelraw, level);
        }
        public RESULT get3DPanLevel         (ref float level)
        {
            return Interface.FMOD_Channel_Get3DPanLevel(channelraw, ref level);
        }
        public RESULT set3DDopplerLevel     (float level)
        {
            return Interface.FMOD_Channel_Set3DDopplerLevel(channelraw, level);
        }
        public RESULT get3DDopplerLevel     (ref float level)
        {
            return Interface.FMOD_Channel_Get3DDopplerLevel(channelraw, ref level);
        }
        ...
        public RESULT isPlaying             (ref bool isplaying)
        {
            ...
            result = Interface.FMOD_Channel_IsPlaying(channelraw, ref p);
        ...
        public RESULT isVirtual             (ref bool isvirtual)
        {
            ...
            result = Interface.FMOD_Channel_IsVirtual(channelraw, ref v);
        ...
        {
            return Interface.FMOD_Channel_GetAudibility(channelraw, ref audibility);
        }
        public RESULT getCurrentSound       (ref Sound sound)
        {
            ...
            try
            {
                result = Interface.FMOD_Channel_GetCurrentSound(channelraw, ref soundraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT getSpectrum           (float[] spectrumarray, int numvalues, int channeloffset, DSP_FFT_WINDOW windowtype)
        {
            return Interface.FMOD_Channel_GetSpectrum(channelraw, spectrumarray, numvalues, channeloffset, windowtype);
        }
        public RESULT getWaveData           (float[] wavearray, int numvalues, int channeloffset)
        {
            return Interface.FMOD_Channel_GetWaveData(channelraw, wavearray, numvalues, channeloffset);
        }
        public RESULT getIndex              (ref int index)
        {
            return Interface.FMOD_Channel_GetIndex(channelraw, ref index);
        }
        ...
        public RESULT getDSPHead            (ref DSP dsp)
        {
            ...
            try
            {
                result = Interface.FMOD_Channel_GetDSPHead(channelraw, ref dspraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT addDSP                (DSP dsp, ref DSPConnection connection)
        {
            ...
            try
            {
                result = Interface.FMOD_Channel_AddDSP(channelraw, dsp.getRaw(), ref dspconnectionraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT setMode               (MODE mode)
        {
            return Interface.FMOD_Channel_SetMode(channelraw, mode);
        }
        public RESULT getMode               (ref MODE mode)
        {
            return Interface.FMOD_Channel_GetMode(channelraw, ref mode);
        }
        public RESULT setLoopCount          (int loopcount)
        {
            return Interface.FMOD_Channel_SetLoopCount(channelraw, loopcount);
        }
        public RESULT getLoopCount          (ref int loopcount)
        {
            return Interface.FMOD_Channel_GetLoopCount(channelraw, ref loopcount);
        }
        public RESULT setLoopPoints         (uint loopstart, TIMEUNIT loopstarttype, uint loopend, TIMEUNIT loopendtype)
        {
            return Interface.FMOD_Channel_SetLoopPoints(channelraw, loopstart, loopstarttype, loopend, loopendtype);
        }
        public RESULT getLoopPoints         (ref uint loopstart, TIMEUNIT loopstarttype, ref uint loopend, TIMEUNIT loopendtype)
        {
            return Interface.FMOD_Channel_GetLoopPoints(channelraw, ref loopstart, loopstarttype, ref loopend, loopendtype);
        }


        public RESULT setUserData           (IntPtr userdata)
        {
            return Interface.FMOD_Channel_SetUserData(channelraw, userdata);
        }
        public RESULT getUserData           (ref IntPtr userdata)
        {
            return Interface.FMOD_Channel_GetUserData(channelraw, ref userdata);
        }

        public RESULT getMemoryInfo(uint memorybits, uint event_memorybits, ref uint memoryused, ref MEMORY_USAGE_DETAILS memoryused_details)
        {
            return Interface.FMOD_Channel_GetMemoryInfo(channelraw, memorybits, event_memorybits, ref memoryused, ref memoryused_details);
        }
    ...
    */
    public class ChannelGroup
    {
        public RESULT release                ()
        {
            return Interface.FMOD_ChannelGroup_Release(channelgroupraw);
        }
        public RESULT getSystemObject        (ref System system)
        {
            RESULT result = RESULT.OK;
            ...
            try
            {
                result = Interface.FMOD_ChannelGroup_GetSystemObject(channelgroupraw, ref systemraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT setVolume              (float volume)
        {
            return Interface.FMOD_ChannelGroup_SetVolume(channelgroupraw, volume);
        }
        public RESULT getVolume              (ref float volume)
        {
            return Interface.FMOD_ChannelGroup_GetVolume(channelgroupraw, ref volume);
        }
        public RESULT setPitch               (float pitch)
        {
            return Interface.FMOD_ChannelGroup_SetPitch(channelgroupraw, pitch);
        }
        public RESULT getPitch               (ref float pitch)
        {
            return Interface.FMOD_ChannelGroup_GetPitch(channelgroupraw, ref pitch);
        }
        public RESULT set3DOcclusion               (float directocclusion, float reverbocclusion)
        {
            return Interface.FMOD_ChannelGroup_Set3DOcclusion(channelgroupraw, directocclusion, reverbocclusion);
        }
        public RESULT get3DOcclusion               (ref float directocclusion, ref float reverbocclusion)
        {
            return Interface.FMOD_ChannelGroup_Get3DOcclusion(channelgroupraw, ref directocclusion, ref reverbocclusion);
        }
        public RESULT setPaused              (bool paused)
        {
            return Interface.FMOD_ChannelGroup_SetPaused(channelgroupraw, (paused ? 1 : 0));
        }
        public RESULT getPaused              (ref bool paused)
        {
            RESULT result;
            ...
            result = Interface.FMOD_ChannelGroup_GetPaused(channelgroupraw, ref p);
        ...
        public RESULT setMute                (bool mute)
        {
            return Interface.FMOD_ChannelGroup_SetMute(channelgroupraw, (mute ? 1 : 0));
        }
        public RESULT getMute                (ref bool mute)
        {
            RESULT result;
            ...
            result = Interface.FMOD_ChannelGroup_GetMute(channelgroupraw, ref m);
        ...
        public RESULT stop                   ()
        {
            return Interface.FMOD_ChannelGroup_Stop(channelgroupraw);
        }
        public RESULT overrideVolume         (float volume)
        {
            return Interface.FMOD_ChannelGroup_OverrideVolume(channelgroupraw, volume);
        }
        public RESULT overrideFrequency      (float frequency)
        {
            return Interface.FMOD_ChannelGroup_OverrideFrequency(channelgroupraw, frequency);
        }
        public RESULT overridePan            (float pan)
        {
            return Interface.FMOD_ChannelGroup_OverridePan(channelgroupraw, pan);
        }
        public RESULT overrideReverbProperties (ref REVERB_CHANNELPROPERTIES prop)
        {
            return Interface.FMOD_ChannelGroup_OverrideReverbProperties(channelgroupraw, ref prop);
        }
        public RESULT override3DAttributes   (ref VECTOR pos, ref VECTOR vel)
        {
            return Interface.FMOD_ChannelGroup_Override3DAttributes(channelgroupraw, ref pos, ref vel);
        }
        ...
        {
            return Interface.FMOD_ChannelGroup_OverrideSpeakerMix(channelgroupraw, frontleft, frontright, center, lfe, backleft, backright, sideleft, sideright);
        }
        ...
        {
            return Interface.FMOD_ChannelGroup_AddGroup(channelgroupraw, group.getRaw());
        }
        public RESULT getNumGroups           (ref int numgroups)
        {
            return Interface.FMOD_ChannelGroup_GetNumGroups(channelgroupraw, ref numgroups);
        }
        public RESULT getGroup               (int index, ref ChannelGroup group)
        {
            ...
            try
            {
                result = Interface.FMOD_ChannelGroup_GetGroup(channelgroupraw, index, ref channelraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT getParentGroup         (ref ChannelGroup group)
        {
            ...
            try
            {
                result = Interface.FMOD_ChannelGroup_GetParentGroup(channelgroupraw, ref channelraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT getDSPHead             (ref DSP dsp)
        {
            ...
            try
            {
                result = Interface.FMOD_ChannelGroup_GetDSPHead(channelgroupraw, ref dspraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT addDSP                 (DSP dsp, ref DSPConnection connection)
        {
            ...
            try
            {
                result = Interface.FMOD_ChannelGroup_AddDSP(channelgroupraw, dsp.getRaw(), ref dspconnectionraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT getName                (StringBuilder name, int namelen)
        {
            return Interface.FMOD_ChannelGroup_GetName(channelgroupraw, name, namelen);
        }
        public RESULT getNumChannels         (ref int numchannels)
        {
            return Interface.FMOD_ChannelGroup_GetNumChannels(channelgroupraw, ref numchannels);
        }
        public RESULT getChannel             (int index, ref Channel channel)
        {
            ...
            try
            {
                result = Interface.FMOD_ChannelGroup_GetChannel(channelgroupraw, index, ref channelraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT getSpectrum            (float[] spectrumarray, int numvalues, int channeloffset, DSP_FFT_WINDOW windowtype)
        {
            return Interface.FMOD_ChannelGroup_GetSpectrum(channelgroupraw, spectrumarray, numvalues, channeloffset, windowtype);
        }
        public RESULT getWaveData            (float[] wavearray, int numvalues, int channeloffset)
        {
            return Interface.FMOD_ChannelGroup_GetWaveData(channelgroupraw, wavearray, numvalues, channeloffset);
        }
        ...
        public RESULT setUserData            (IntPtr userdata)
        {
            return Interface.FMOD_ChannelGroup_SetUserData(channelgroupraw, userdata);
        }
        public RESULT getUserData            (ref IntPtr userdata)
        {
            return Interface.FMOD_ChannelGroup_GetUserData(channelgroupraw, ref userdata);
        }

        public RESULT getMemoryInfo(uint memorybits, uint event_memorybits, ref uint memoryused, ref MEMORY_USAGE_DETAILS memoryused_details)
        {
            return Interface.FMOD_ChannelGroup_GetMemoryInfo(channelgroupraw, memorybits, event_memorybits, ref memoryused, ref memoryused_details);
        }
    ...
    */
    public class SoundGroup
    {
        public RESULT release                ()
        {
            return Interface.FMOD_SoundGroup_Release(soundgroupraw);
        }
        ...
        public RESULT getSystemObject        (ref System system)
        {
            ...
            try
            {
                result = Interface.FMOD_SoundGroup_GetSystemObject(soundgroupraw, ref systemraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        {
            return Interface.FMOD_SoundGroup_SetMaxAudible(soundgroupraw, maxaudible);
        }

        public RESULT getMaxAudible          (ref int maxaudible)
        {
            return Interface.FMOD_SoundGroup_GetMaxAudible(soundgroupraw, ref maxaudible);
        }

        public RESULT setMaxAudibleBehavior  (SOUNDGROUP_BEHAVIOR behavior)
        {
            return Interface.FMOD_SoundGroup_SetMaxAudibleBehavior(soundgroupraw, behavior);
        }
        public RESULT getMaxAudibleBehavior  (ref SOUNDGROUP_BEHAVIOR behavior)
        {
            return Interface.FMOD_SoundGroup_GetMaxAudibleBehavior(soundgroupraw, ref behavior);
        }
        public RESULT setMuteFadeSpeed       (float speed)
        {
            return Interface.FMOD_SoundGroup_SetMuteFadeSpeed(soundgroupraw, speed);
        }
        public RESULT getMuteFadeSpeed       (ref float speed)
        {
            return Interface.FMOD_SoundGroup_GetMuteFadeSpeed(soundgroupraw, ref speed);
        }
        
        public RESULT setVolume       (float volume)
        {
            return Interface.FMOD_SoundGroup_SetVolume(soundgroupraw, volume);
        }        
        public RESULT getVolume       (ref float volume)
        {
            return Interface.FMOD_SoundGroup_GetVolume(soundgroupraw, ref volume);
        }
        public RESULT stop       ()
        {
            return Interface.FMOD_SoundGroup_Stop(soundgroupraw);
        }

        // Information only functions.
        public RESULT getName                (StringBuilder name, int namelen)
        {
            return Interface.FMOD_SoundGroup_GetName(soundgroupraw, name, namelen);
        }
        public RESULT getNumSounds           (ref int numsounds)
        {
            return Interface.FMOD_SoundGroup_GetNumSounds(soundgroupraw, ref numsounds);
        }
        public RESULT getSound               (int index, ref Sound sound)
        {
            ...
            try
            {
                result = Interface.FMOD_SoundGroup_GetSound(soundgroupraw, index, ref soundraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        {
            return Interface.FMOD_SoundGroup_GetNumPlaying(soundgroupraw, ref numplaying);
        }

        // Userdata set/get.
        public RESULT setUserData            (IntPtr userdata)
        {
            return Interface.FMOD_SoundGroup_SetUserData(soundgroupraw, userdata);
        }
        public RESULT getUserData            (ref IntPtr userdata)
        {
            return Interface.FMOD_SoundGroup_GetUserData(soundgroupraw, ref userdata);
        }

        public RESULT getMemoryInfo(uint memorybits, uint event_memorybits, ref uint memoryused, ref MEMORY_USAGE_DETAILS memoryused_details)
        {
            return Interface.FMOD_SoundGroup_GetMemoryInfo(soundgroupraw, memorybits, event_memorybits, ref memoryused, ref memoryused_details);
        }
    ...
    */
    public class DSP
    {
        public RESULT release                   ()
        {
            return Interface.FMOD_DSP_Release(dspraw);
        }
        public RESULT getSystemObject           (ref System system)
        {
            RESULT result         = RESULT.OK;
            ...
            try
            {
                result = Interface.FMOD_DSP_GetSystemObject(dspraw, ref systemraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT addInput(DSP target, ref DSPConnection connection)
        {
            ...
            try
            {
                result = Interface.FMOD_DSP_AddInput(dspraw, target.getRaw(), ref dspconnectionraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        {
            return Interface.FMOD_DSP_DisconnectFrom(dspraw, target.getRaw());
        }
        public RESULT disconnectAll             (bool inputs, bool outputs)
        {
            return Interface.FMOD_DSP_DisconnectAll(dspraw, (inputs ? 1 : 0), (outputs ? 1 : 0));
        }
        public RESULT remove                    ()
        {
            return Interface.FMOD_DSP_Remove(dspraw);
        }
        public RESULT getNumInputs              (ref int numinputs)
        {
            return Interface.FMOD_DSP_GetNumInputs(dspraw, ref numinputs);
        }
        public RESULT getNumOutputs             (ref int numoutputs)
        {
            return Interface.FMOD_DSP_GetNumOutputs(dspraw, ref numoutputs);
        }
        public RESULT getInput                  (int index, ref DSP input, ref DSPConnection inputconnection)
        {
            ...
            try
            {
                result = Interface.FMOD_DSP_GetInput(dspraw, index, ref dsprawnew, ref dspconnectionraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT getOutput                 (int index, ref DSP output, ref DSPConnection outputconnection)
        {
            ...
            try
            {
                result = Interface.FMOD_DSP_GetOutput(dspraw, index, ref dsprawnew, ref dspconnectionraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        {
            return Interface.FMOD_DSP_SetActive(dspraw, (active ? 1 : 0));
        }
        public RESULT getActive                 (ref bool active)
        {
            ...
            result = Interface.FMOD_DSP_GetActive(dspraw, ref a);
        ...
        {
            return Interface.FMOD_DSP_SetBypass(dspraw, (bypass? 1 : 0));
        }
        public RESULT getBypass                 (ref bool bypass)
        {
            ...
            result = Interface.FMOD_DSP_GetBypass(dspraw, ref b);
        ...
        {
            return Interface.FMOD_DSP_SetSpeakerActive(dspraw, speaker, (active ? 1 : 0));
        }
        public RESULT getSpeakerActive                 (SPEAKER speaker, ref bool active)
        {
            ...
            result = Interface.FMOD_DSP_GetSpeakerActive(dspraw, speaker, ref a);
        ...
        public RESULT reset                     ()
        {
            return Interface.FMOD_DSP_Reset(dspraw);
        }

                     
        public RESULT setParameter              (int index, float value)
        {
            return Interface.FMOD_DSP_SetParameter(dspraw, index, value);
        }
        public RESULT getParameter              (int index, ref float value, StringBuilder valuestr, int valuestrlen)
        {
            return Interface.FMOD_DSP_GetParameter(dspraw, index, ref value, valuestr, valuestrlen);
        }
        public RESULT getNumParameters          (ref int numparams)
        {
            return Interface.FMOD_DSP_GetNumParameters(dspraw, ref numparams);
        }
        ...
        {
            return Interface.FMOD_DSP_GetParameterInfo(dspraw, index, name, label, description, descriptionlen, ref min, ref max);
        }
        public RESULT showConfigDialog          (IntPtr hwnd, bool show)
        {
            return Interface.FMOD_DSP_ShowConfigDialog          (dspraw, hwnd, (show ? 1 : 0));
        }


        public RESULT getInfo                   (ref IntPtr name, ref uint version, ref int channels, ref int configwidth, ref int configheight)
        {
            return Interface.FMOD_DSP_GetInfo(dspraw, ref name, ref version, ref channels, ref configwidth, ref configheight);
        }
        public RESULT getType                   (ref DSP_TYPE type)
        {
            return Interface.FMOD_DSP_GetType(dspraw, ref type);
        }
        public RESULT setDefaults               (float frequency, float volume, float pan, int priority)
        {
            return Interface.FMOD_DSP_SetDefaults(dspraw, frequency, volume, pan, priority);
        }
        public RESULT getDefaults               (ref float frequency, ref float volume, ref float pan, ref int priority)
        {
            return Interface.FMOD_DSP_GetDefaults(dspraw, ref frequency, ref volume, ref pan, ref priority);
        }


        public RESULT setUserData               (IntPtr userdata)
        {
            return Interface.FMOD_DSP_SetUserData(dspraw, userdata);
        }
        public RESULT getUserData               (ref IntPtr userdata)
        {
            return Interface.FMOD_DSP_GetUserData(dspraw, ref userdata);
        }

        public RESULT getMemoryInfo(uint memorybits, uint event_memorybits, ref uint memoryused, ref MEMORY_USAGE_DETAILS memoryused_details)
        {
            return Interface.FMOD_DSP_GetMemoryInfo(dspraw, memorybits, event_memorybits, ref memoryused, ref memoryused_details);
        }
    ...
    */
    public class DSPConnection
    {
        public RESULT getInput              (ref DSP input)
        {
            ...
            try
            {
                result = Interface.FMOD_DSPConnection_GetInput(dspconnectionraw, ref dspraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        public RESULT getOutput             (ref DSP output)
        {
            ...
            try
            {
                result = Interface.FMOD_DSPConnection_GetOutput(dspconnectionraw, ref dspraw);
            }
            catch
            {
                result = RESULT.ERR_INVALID_PARAM;
        ...
        {
            return Interface.FMOD_DSPConnection_SetMix(dspconnectionraw, volume);
        }
        public RESULT getMix                (ref float volume)
        {
            return Interface.FMOD_DSPConnection_GetMix(dspconnectionraw, ref volume);
        }
        public RESULT setLevels             (SPEAKER speaker, float[] levels, int numlevels)
        {
            return Interface.FMOD_DSPConnection_SetLevels(dspconnectionraw, speaker, levels, numlevels);
        }
        public RESULT getLevels             (SPEAKER speaker, float[] levels, int numlevels)
        {
            return Interface.FMOD_DSPConnection_GetLevels(dspconnectionraw, speaker, levels, numlevels);
        }
        public RESULT setUserData(IntPtr userdata)
        {
            return Interface.FMOD_DSPConnection_SetUserData(dspconnectionraw, userdata);
        }
        public RESULT getUserData(ref IntPtr userdata)
        {
            return Interface.FMOD_DSPConnection_GetUserData(dspconnectionraw, ref userdata);
        }

        public RESULT getMemoryInfo(uint memorybits, uint event_memorybits, ref uint memoryused, ref MEMORY_USAGE_DETAILS memoryused_details)
        {
            return Interface.FMOD_DSPConnection_GetMemoryInfo(dspconnectionraw, memorybits, event_memorybits, ref memoryused, ref memoryused_details);
        }
    ...
    */
    public class Geometry
    {
        public RESULT release               ()
        {
            return Interface.FMOD_Geometry_Release(geometryraw);
        }       
        ...
        {
            return Interface.FMOD_Geometry_AddPolygon(geometryraw, directocclusion, reverbocclusion, (doublesided ? 1 : 0), numvertices, vertices, ref polygonindex);
        }


        public RESULT getNumPolygons        (ref int numpolygons)
        {
            return Interface.FMOD_Geometry_GetNumPolygons(geometryraw, ref numpolygons);
        }
        public RESULT getMaxPolygons        (ref int maxpolygons, ref int maxvertices)
        {
            return Interface.FMOD_Geometry_GetMaxPolygons(geometryraw, ref maxpolygons, ref maxvertices);
        }
        public RESULT getPolygonNumVertices (int index, ref int numvertices)
        {
            return Interface.FMOD_Geometry_GetPolygonNumVertices(geometryraw, index, ref numvertices);
        }
        public RESULT setPolygonVertex      (int index, int vertexindex, ref VECTOR vertex)
        {
            return Interface.FMOD_Geometry_SetPolygonVertex(geometryraw, index, vertexindex, ref vertex);
        }
        public RESULT getPolygonVertex      (int index, int vertexindex, ref VECTOR vertex)
        {
            return Interface.FMOD_Geometry_GetPolygonVertex(geometryraw, index, vertexindex, ref vertex);
        }
        public RESULT setPolygonAttributes  (int index, float directocclusion, float reverbocclusion, bool doublesided)
        {
            return Interface.FMOD_Geometry_SetPolygonAttributes(geometryraw, index, directocclusion, reverbocclusion, (doublesided ? 1 : 0));
        }
        public RESULT getPolygonAttributes  (int index, ref float directocclusion, ref float reverbocclusion, ref bool doublesided)
        {
            ...
            result = Interface.FMOD_Geometry_GetPolygonAttributes(geometryraw, index, ref directocclusion, ref reverbocclusion, ref ds);
        ...
        public RESULT setActive             (bool active)
        {
            return Interface.FMOD_Geometry_SetActive  (geometryraw, (active ? 1 : 0));
        }
        public RESULT getActive             (ref bool active)
        {
            RESULT result;
            ...
            result = Interface.FMOD_Geometry_GetActive  (geometryraw, ref a);
        ...
        {
            return Interface.FMOD_Geometry_SetRotation(geometryraw, ref forward, ref up);
        }
        public RESULT getRotation           (ref VECTOR forward, ref VECTOR up)
        {
            return Interface.FMOD_Geometry_GetRotation(geometryraw, ref forward, ref up);
        }
        public RESULT setPosition           (ref VECTOR position)
        {
            return Interface.FMOD_Geometry_SetPosition(geometryraw, ref position);
        }
        public RESULT getPosition           (ref VECTOR position)
        {
            return Interface.FMOD_Geometry_GetPosition(geometryraw, ref position);
        }
        public RESULT setScale              (ref VECTOR scale)
        {
            return Interface.FMOD_Geometry_SetScale(geometryraw, ref scale);
        }
        public RESULT getScale              (ref VECTOR scale)
        {
            return Interface.FMOD_Geometry_GetScale(geometryraw, ref scale);
        }
        public RESULT save                  (IntPtr data, ref int datasize)
        {
            return Interface.FMOD_Geometry_Save(geometryraw, data, ref datasize);
        }


        public RESULT setUserData               (IntPtr userdata)
        {
            return Interface.FMOD_Geometry_SetUserData(geometryraw, userdata);
        }
        public RESULT getUserData               (ref IntPtr userdata)
        {
            return Interface.FMOD_Geometry_GetUserData(geometryraw, ref userdata);
        }

        public RESULT getMemoryInfo(uint memorybits, uint event_memorybits, ref uint memoryused, ref MEMORY_USAGE_DETAILS memoryused_details)
        {
            return Interface.FMOD_Geometry_GetMemoryInfo(geometryraw, memorybits, event_memorybits, ref memoryused, ref memoryused_details);
        }
    ...
    */
    public class Reverb
    {
        ...
        public RESULT release()
        {
            return Interface.FMOD_Reverb_Release(reverbraw);
        }

        // Reverb manipulation.
        public RESULT set3DAttributes(ref VECTOR position, float mindistance, float maxdistance)
        {
            return Interface.FMOD_Reverb_Set3DAttributes(reverbraw, ref position, mindistance, maxdistance);
        }
        public RESULT get3DAttributes(ref VECTOR position, ref float mindistance, ref float maxdistance)
        {
            return Interface.FMOD_Reverb_Get3DAttributes(reverbraw, ref position, ref mindistance, ref maxdistance);
        }
        public RESULT setProperties(ref REVERB_PROPERTIES properties)
        {
            return Interface.FMOD_Reverb_SetProperties(reverbraw, ref properties);
        }
        public RESULT getProperties(ref REVERB_PROPERTIES properties)
        {
            return Interface.FMOD_Reverb_GetProperties(reverbraw, ref properties);
        }
        public RESULT setActive(bool active)
        {
            return Interface.FMOD_Reverb_SetActive(reverbraw, (active ? 1 : 0));
        }
        public RESULT getActive(ref bool active)
        {
            RESULT result;
            ...
            result = Interface.FMOD_Reverb_GetActive(reverbraw, ref a);
        ...
        public RESULT setUserData(IntPtr userdata)
        {
            return Interface.FMOD_Reverb_SetUserData(reverbraw, userdata);
        }
        public RESULT getUserData(ref IntPtr userdata)
        {
            return Interface.FMOD_Reverb_GetUserData(reverbraw, ref userdata);
        }

        public RESULT getMemoryInfo(uint memorybits, uint event_memorybits, ref uint memoryused, ref MEMORY_USAGE_DETAILS memoryused_details)
        {
            return Interface.FMOD_Reverb_GetMemoryInfo(reverbraw, memorybits, event_memorybits, ref memoryused, ref memoryused_details);
        }
    ...
    public class Interface
    {
        ...
        internal static extern RESULT FMOD_System_Create(ref IntPtr system);

        #region importfunctions

        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Reverb_Release(IntPtr reverb);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Reverb_Set3DAttributes(IntPtr reverb, ref VECTOR position, float mindistance, float maxdistance);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Reverb_Get3DAttributes(IntPtr reverb, ref VECTOR position, ref float mindistance, ref float maxdistance);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Reverb_SetProperties(IntPtr reverb, ref REVERB_PROPERTIES properties);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Reverb_GetProperties(IntPtr reverb, ref REVERB_PROPERTIES properties);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Reverb_SetActive(IntPtr reverb, int active);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Reverb_GetActive(IntPtr reverb, ref int active);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Reverb_SetUserData(IntPtr reverb, IntPtr userdata);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Reverb_GetUserData(IntPtr reverb, ref IntPtr userdata);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Reverb_GetMemoryInfo(IntPtr reverb, uint memorybits, uint event_memorybits, ref uint memoryused, ref MEMORY_USAGE_DETAILS memoryused_details);
        #endregion

        #region importfunctions

        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Memory_GetStats(ref int currentalloced, ref int maxalloced, int blocking);
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetOutput(IntPtr system, ref OUTPUTTYPE output);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetNumDrivers(IntPtr system, ref int numdrivers);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetDriverInfo(IntPtr system, int id, StringBuilder name, int namelen, ref GUID guid);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetDriverInfoW(IntPtr system, int id, [MarshalAs(UnmanagedType.LPWStr)]StringBuilder name, int namelen, ref GUID guid);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetDriverCaps(IntPtr system, int id, ref CAPS caps, ref int controlpaneloutputrate, ref SPEAKERMODE controlpanelspeakermode);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetDriver(IntPtr system, int driver);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetDriver(IntPtr system, ref int driver);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetHardwareChannels(IntPtr system, int numhardwarechannels);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetHardwareChannels(IntPtr system, ref int numhardwarechannels);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetSoftwareChannels(IntPtr system, int numsoftwarechannels);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetSoftwareChannels(IntPtr system, ref int numsoftwarechannels);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetSoftwareFormat(IntPtr system, int samplerate, SOUND_FORMAT format, int numoutputchannels, int maxinputchannels, DSP_RESAMPLER resamplemethod);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetSoftwareFormat(IntPtr system, ref int samplerate, ref SOUND_FORMAT format, ref int numoutputchannels, ref int maxinputchannels, ref DSP_RESAMPLER resamplemethod, ref int bits);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetDSPBufferSize(IntPtr system, uint bufferlength, int numbuffers);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetDSPBufferSize(IntPtr system, ref uint bufferlength, ref int numbuffers);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetFileSystem(IntPtr system, FILE_OPENCALLBACK useropen, FILE_CLOSECALLBACK userclose, FILE_READCALLBACK userread, FILE_SEEKCALLBACK userseek, FILE_ASYNCREADCALLBACK userasyncread, FILE_ASYNCCANCELCALLBACK userasynccancel, int blockalign);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_AttachFileSystem(IntPtr system, FILE_OPENCALLBACK useropen, FILE_CLOSECALLBACK userclose, FILE_READCALLBACK userread, FILE_SEEKCALLBACK userseek);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetPluginPath(IntPtr system, string path);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_LoadPlugin(IntPtr system, string filename, ref uint handle, uint priority);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_UnloadPlugin(IntPtr system, uint handle);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetNumPlugins(IntPtr system, PLUGINTYPE plugintype, ref int numplugins);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetPluginHandle(IntPtr system, PLUGINTYPE plugintype, int index, ref uint handle);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetPluginInfo(IntPtr system, uint handle, ref PLUGINTYPE plugintype, StringBuilder name, int namelen, ref uint version);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_CreateDSPByPlugin(IntPtr system, uint handle, ref IntPtr dsp);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_CreateCodec(IntPtr system, IntPtr description, uint priority);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetOutputByPlugin(IntPtr system, uint handle);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetOutputByPlugin(IntPtr system, ref uint handle);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_UpdateFinished(IntPtr system);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetAdvancedSettings(IntPtr system, ref ADVANCEDSETTINGS settings);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetAdvancedSettings(IntPtr system, ref ADVANCEDSETTINGS settings);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetSpeakerMode(IntPtr system, SPEAKERMODE speakermode);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetSpeakerMode(IntPtr system, ref SPEAKERMODE speakermode);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_Set3DRolloffCallback(IntPtr system, CB_3D_ROLLOFFCALLBACK callback);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetCallback(IntPtr system, SYSTEM_CALLBACK callback);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_Set3DSpeakerPosition(IntPtr system, SPEAKER speaker, float x, float y, int active);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_Get3DSpeakerPosition(IntPtr system, SPEAKER speaker, ref float x, ref float y, ref int active);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_Set3DSettings(IntPtr system, float dopplerscale, float distancefactor, float rolloffscale);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_Get3DSettings(IntPtr system, ref float dopplerscale, ref float distancefactor, ref float rolloffscale);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_Set3DNumListeners(IntPtr system, int numlisteners);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_Get3DNumListeners(IntPtr system, ref int numlisteners);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_Set3DListenerAttributes(IntPtr system, int listener, ref VECTOR pos, ref VECTOR vel, ref VECTOR forward, ref VECTOR up);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_Get3DListenerAttributes(IntPtr system, int listener, ref VECTOR pos, ref VECTOR vel, ref VECTOR forward, ref VECTOR up);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetFileBufferSize(IntPtr system, int sizebytes);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetFileBufferSize(IntPtr system, ref int sizebytes);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetStreamBufferSize(IntPtr system, uint filebuffersize, TIMEUNIT filebuffersizetype);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetStreamBufferSize(IntPtr system, ref uint filebuffersize, ref TIMEUNIT filebuffersizetype);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetVersion(IntPtr system, ref uint version);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetOutputHandle(IntPtr system, ref IntPtr handle);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetChannelsPlaying(IntPtr system, ref int channels);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetCPUUsage(IntPtr system, ref float dsp, ref float stream, ref float geometry, ref float update, ref float total);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetSoundRAM(IntPtr system, ref int currentalloced, ref int maxalloced, ref int total);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetNumCDROMDrives(IntPtr system, ref int numdrives);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetCDROMDriveName(IntPtr system, int drive, StringBuilder drivename, int drivenamelen, StringBuilder scsiname, int scsinamelen, StringBuilder devicename, int devicenamelen);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetSpectrum(IntPtr system, [MarshalAs(UnmanagedType.LPArray)]float[] spectrumarray, int numvalues, int channeloffset, DSP_FFT_WINDOW windowtype);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetWaveData(IntPtr system, [MarshalAs(UnmanagedType.LPArray)]float[] wavearray, int numvalues, int channeloffset);
        //[DllImport(VERSION.dll, CharSet = CharSet.Unicode)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_CreateSound(IntPtr system, string name_or_data, MODE mode, ref CREATESOUNDEXINFO exinfo, ref IntPtr sound);
        //[DllImport(VERSION.dll, CharSet = CharSet.Unicode)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_CreateStream(IntPtr system, string name_or_data, MODE mode, ref CREATESOUNDEXINFO exinfo, ref IntPtr sound);
        //[DllImport(VERSION.dll, CharSet = CharSet.Unicode)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_CreateSound(IntPtr system, string name_or_data, MODE mode, int exinfo, ref IntPtr sound);
        //[DllImport(VERSION.dll, CharSet = CharSet.Unicode)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_CreateStream(IntPtr system, string name_or_data, MODE mode, int exinfo, ref IntPtr sound);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_CreateSound(IntPtr system, byte[] name_or_data, MODE mode, ref CREATESOUNDEXINFO exinfo, ref IntPtr sound);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_CreateStream(IntPtr system, byte[] name_or_data, MODE mode, ref CREATESOUNDEXINFO exinfo, ref IntPtr sound);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_CreateSound(IntPtr system, byte[] name_or_data, MODE mode, int exinfo, ref IntPtr sound);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_CreateStream(IntPtr system, byte[] name_or_data, MODE mode, int exinfo, ref IntPtr sound);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_CreateDSP(IntPtr system, ref DSP_DESCRIPTION description, ref IntPtr dsp);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_CreateDSPByType(IntPtr system, DSP_TYPE type, ref IntPtr dsp);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_CreateChannelGroup(IntPtr system, string name, ref IntPtr channelgroup);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_CreateSoundGroup(IntPtr system, string name, ref IntPtr soundgroup);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_CreateReverb(IntPtr system, ref IntPtr reverb);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_PlaySound(IntPtr system, CHANNELINDEX channelid, IntPtr sound, int paused, ref IntPtr channel);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_PlayDSP(IntPtr system, CHANNELINDEX channelid, IntPtr dsp, int paused, ref IntPtr channel);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetChannel(IntPtr system, int channelid, ref IntPtr channel);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetMasterChannelGroup(IntPtr system, ref IntPtr channelgroup);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetMasterSoundGroup(IntPtr system, ref IntPtr soundgroup);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetReverbProperties(IntPtr system, ref REVERB_PROPERTIES prop);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetReverbProperties(IntPtr system, ref REVERB_PROPERTIES prop);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetReverbAmbientProperties(IntPtr system, ref REVERB_PROPERTIES prop);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetReverbAmbientProperties(IntPtr system, ref REVERB_PROPERTIES prop);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetDSPHead(IntPtr system, ref IntPtr dsp);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_AddDSP(IntPtr system, IntPtr dsp, ref IntPtr connection);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_LockDSP(IntPtr system);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_UnlockDSP(IntPtr system);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetDSPClock(IntPtr system, ref uint hi, ref uint lo);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetRecordNumDrivers(IntPtr system, ref int numdrivers);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetRecordDriverInfo(IntPtr system, int id, StringBuilder name, int namelen, ref GUID guid);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetRecordDriverInfoW(IntPtr system, int id, [MarshalAs(UnmanagedType.LPWStr)]StringBuilder name, int namelen, ref GUID guid);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetRecordDriverCaps(IntPtr system, int id, ref CAPS caps, ref int minfrequency, ref int maxfrequency);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetRecordPosition(IntPtr system, int id, ref uint position);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_RecordStart(IntPtr system, int id, IntPtr sound, int loop);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_RecordStop(IntPtr system, int id);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_IsRecording(IntPtr system, int id, ref int recording);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_CreateGeometry(IntPtr system, int maxpolygons, int maxvertices, ref IntPtr geometry);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetGeometrySettings(IntPtr system, float maxworldsize);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetGeometrySettings(IntPtr system, ref float maxworldsize);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_LoadGeometry(IntPtr system, IntPtr data, int datasize, ref IntPtr geometry);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetGeometryOcclusion(IntPtr system, ref VECTOR listener, ref VECTOR source, ref float direct, ref float reverb);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetNetworkProxy(IntPtr system, string proxy);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetNetworkProxy(IntPtr system, StringBuilder proxy, int proxylen);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetNetworkTimeout(IntPtr system, int timeout);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetNetworkTimeout(IntPtr system, ref int timeout);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_SetUserData(IntPtr system, IntPtr userdata);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetUserData(IntPtr system, ref IntPtr userdata);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_System_GetMemoryInfo(IntPtr system, uint memorybits, uint event_memorybits, ref uint memoryused, ref MEMORY_USAGE_DETAILS memoryused_details);
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetSystemObject(IntPtr sound, ref IntPtr system);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_Lock(IntPtr sound, uint offset, uint length, ref IntPtr ptr1, ref IntPtr ptr2, ref uint len1, ref uint len2);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_Unlock(IntPtr sound, IntPtr ptr1, IntPtr ptr2, uint len1, uint len2);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_SetDefaults(IntPtr sound, float frequency, float volume, float pan, int priority);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetDefaults(IntPtr sound, ref float frequency, ref float volume, ref float pan, ref int priority);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_SetVariations(IntPtr sound, float frequencyvar, float volumevar, float panvar);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetVariations(IntPtr sound, ref float frequencyvar, ref float volumevar, ref float panvar);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_Set3DMinMaxDistance(IntPtr sound, float min, float max);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_Get3DMinMaxDistance(IntPtr sound, ref float min, ref float max);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_Set3DConeSettings(IntPtr sound, float insideconeangle, float outsideconeangle, float outsidevolume);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_Get3DConeSettings(IntPtr sound, ref float insideconeangle, ref float outsideconeangle, ref float outsidevolume);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_Set3DCustomRolloff(IntPtr sound, ref VECTOR points, int numpoints);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_Get3DCustomRolloff(IntPtr sound, ref IntPtr points, ref int numpoints);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_SetSubSound(IntPtr sound, int index, IntPtr subsound);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetSubSound(IntPtr sound, int index, ref IntPtr subsound);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_SetSubSoundSentence(IntPtr sound, int[] subsoundlist, int numsubsounds);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetName(IntPtr sound, StringBuilder name, int namelen);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetLength(IntPtr sound, ref uint length, TIMEUNIT lengthtype);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetFormat(IntPtr sound, ref SOUND_TYPE type, ref SOUND_FORMAT format, ref int channels, ref int bits);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetNumSubSounds(IntPtr sound, ref int numsubsounds);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetNumTags(IntPtr sound, ref int numtags, ref int numtagsupdated);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetTag(IntPtr sound, string name, int index, ref TAG tag);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetOpenState(IntPtr sound, ref OPENSTATE openstate, ref uint percentbuffered, ref int starving, ref int diskbusy);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_ReadData(IntPtr sound, IntPtr buffer, uint lenbytes, ref uint read);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_SeekData(IntPtr sound, uint pcm);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_SetSoundGroup(IntPtr sound, IntPtr soundgroup);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetSoundGroup(IntPtr sound, ref IntPtr soundgroup);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetNumSyncPoints(IntPtr sound, ref int numsyncpoints);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetSyncPoint(IntPtr sound, int index, ref IntPtr point);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetSyncPointInfo(IntPtr sound, IntPtr point, StringBuilder name, int namelen, ref uint offset, TIMEUNIT offsettype);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_AddSyncPoint(IntPtr sound, uint offset, TIMEUNIT offsettype, string name, ref IntPtr point);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_DeleteSyncPoint(IntPtr sound, IntPtr point);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_SetMode(IntPtr sound, MODE mode);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetMode(IntPtr sound, ref MODE mode);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_SetLoopCount(IntPtr sound, int loopcount);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetLoopCount(IntPtr sound, ref int loopcount);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_SetLoopPoints(IntPtr sound, uint loopstart, TIMEUNIT loopstarttype, uint loopend, TIMEUNIT loopendtype);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetLoopPoints(IntPtr sound, ref uint loopstart, TIMEUNIT loopstarttype, ref uint loopend, TIMEUNIT loopendtype);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetMusicNumChannels(IntPtr sound, ref int numchannels);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_SetMusicChannelVolume(IntPtr sound, int channel, float volume);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetMusicChannelVolume(IntPtr sound, int channel, ref float volume);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_SetMusicSpeed(IntPtr sound, float speed);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetMusicSpeed(IntPtr sound, ref float speed);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_SetUserData(IntPtr sound, IntPtr userdata);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetUserData(IntPtr sound, ref IntPtr userdata);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Sound_GetMemoryInfo(IntPtr sound, uint memorybits, uint event_memorybits, ref uint memoryused, ref MEMORY_USAGE_DETAILS memoryused_details);
        #endregion

        #region importfunctions

        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetSystemObject(IntPtr channel, ref IntPtr system);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Stop(IntPtr channel);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetPaused(IntPtr channel, int paused);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetPaused(IntPtr channel, ref int paused);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetVolume(IntPtr channel, float volume);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetVolume(IntPtr channel, ref float volume);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetFrequency(IntPtr channel, float frequency);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetFrequency(IntPtr channel, ref float frequency);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetPan(IntPtr channel, float pan);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetPan(IntPtr channel, ref float pan);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetDelay(IntPtr channel, DELAYTYPE delaytype, uint delayhi, uint delaylo);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetDelay(IntPtr channel, DELAYTYPE delaytype, ref uint delayhi, ref uint delaylo);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetSpeakerMix(IntPtr channel, float frontleft, float frontright, float center, float lfe, float backleft, float backright, float sideleft, float sideright);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetSpeakerMix(IntPtr channel, ref float frontleft, ref float frontright, ref float center, ref float lfe, ref float backleft, ref float backright, ref float sideleft, ref float sideright);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetSpeakerLevels(IntPtr channel, SPEAKER speaker, float[] levels, int numlevels);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetSpeakerLevels(IntPtr channel, SPEAKER speaker, [MarshalAs(UnmanagedType.LPArray)]float[] levels, int numlevels);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetInputChannelMix(IntPtr channel, float[] levels, int numlevels);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetInputChannelMix(IntPtr channel, [MarshalAs(UnmanagedType.LPArray)]float[] levels, int numlevels);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetMute(IntPtr channel, int mute);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetMute(IntPtr channel, ref int mute);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetPriority(IntPtr channel, int priority);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetPriority(IntPtr channel, ref int priority);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Set3DAttributes(IntPtr channel, ref VECTOR pos, ref VECTOR vel);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Get3DAttributes(IntPtr channel, ref VECTOR pos, ref VECTOR vel);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Set3DMinMaxDistance(IntPtr channel, float mindistance, float maxdistance);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Get3DMinMaxDistance(IntPtr channel, ref float mindistance, ref float maxdistance);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Set3DConeSettings(IntPtr channel, float insideconeangle, float outsideconeangle, float outsidevolume);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Get3DConeSettings(IntPtr channel, ref float insideconeangle, ref float outsideconeangle, ref float outsidevolume);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Set3DConeOrientation(IntPtr channel, ref VECTOR orientation);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Get3DConeOrientation(IntPtr channel, ref VECTOR orientation);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Set3DCustomRolloff(IntPtr channel, ref VECTOR points, int numpoints);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Get3DCustomRolloff(IntPtr channel, ref IntPtr points, ref int numpoints);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Set3DOcclusion(IntPtr channel, float directocclusion, float reverbocclusion);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Get3DOcclusion(IntPtr channel, ref float directocclusion, ref float reverbocclusion);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Set3DSpread(IntPtr channel, float angle);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Get3DSpread(IntPtr channel, ref float angle);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Set3DPanLevel(IntPtr channel, float level);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Get3DPanLevel(IntPtr channel, ref float level);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Set3DDopplerLevel(IntPtr channel, float level);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_Get3DDopplerLevel(IntPtr channel, ref float level);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetReverbProperties(IntPtr channel, ref REVERB_CHANNELPROPERTIES prop);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetReverbProperties(IntPtr channel, ref REVERB_CHANNELPROPERTIES prop);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetLowPassGain(IntPtr channel, float gain);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetLowPassGain(IntPtr channel, ref float gain);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetChannelGroup(IntPtr channel, IntPtr channelgroup);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetChannelGroup(IntPtr channel, ref IntPtr channelgroup);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_IsPlaying(IntPtr channel, ref int isplaying);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_IsVirtual(IntPtr channel, ref int isvirtual);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetAudibility(IntPtr channel, ref float audibility);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetCurrentSound(IntPtr channel, ref IntPtr sound);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetSpectrum(IntPtr channel, [MarshalAs(UnmanagedType.LPArray)] float[] spectrumarray, int numvalues, int channeloffset, DSP_FFT_WINDOW windowtype);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetWaveData(IntPtr channel, [MarshalAs(UnmanagedType.LPArray)] float[] wavearray, int numvalues, int channeloffset);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetIndex(IntPtr channel, ref int index);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetCallback(IntPtr channel, CHANNEL_CALLBACK callback);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetPosition(IntPtr channel, uint position, TIMEUNIT postype);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetPosition(IntPtr channel, ref uint position, TIMEUNIT postype);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetDSPHead(IntPtr channel, ref IntPtr dsp);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_AddDSP(IntPtr channel, IntPtr dsp, ref IntPtr connection);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetMode(IntPtr channel, MODE mode);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetMode(IntPtr channel, ref MODE mode);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetLoopCount(IntPtr channel, int loopcount);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetLoopCount(IntPtr channel, ref int loopcount);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetLoopPoints(IntPtr channel, uint loopstart, TIMEUNIT loopstarttype, uint loopend, TIMEUNIT loopendtype);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetLoopPoints(IntPtr channel, ref uint loopstart, TIMEUNIT loopstarttype, ref uint loopend, TIMEUNIT loopendtype);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_SetUserData(IntPtr channel, IntPtr userdata);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetUserData(IntPtr channel, ref IntPtr userdata);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Channel_GetMemoryInfo(IntPtr channel, uint memorybits, uint event_memorybits, ref uint memoryused, ref MEMORY_USAGE_DETAILS memoryused_details);
        #endregion
        #region importfunctions


        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_Release(IntPtr channelgroup);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_GetSystemObject(IntPtr channelgroup, ref IntPtr system);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_SetVolume(IntPtr channelgroup, float volume);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_GetVolume(IntPtr channelgroup, ref float volume);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_SetPitch(IntPtr channelgroup, float pitch);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_GetPitch(IntPtr channelgroup, ref float pitch);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_Set3DOcclusion(IntPtr channelgroup, float directocclusion, float reverbocclusion);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_Get3DOcclusion(IntPtr channelgroup, ref float directocclusion, ref float reverbocclusion);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_SetPaused(IntPtr channelgroup, int paused);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_GetPaused(IntPtr channelgroup, ref int paused);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_SetMute(IntPtr channelgroup, int mute);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_GetMute(IntPtr channelgroup, ref int mute);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_Stop(IntPtr channelgroup);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_OverridePaused(IntPtr channelgroup, int paused);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_OverrideVolume(IntPtr channelgroup, float volume);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_OverrideFrequency(IntPtr channelgroup, float frequency);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_OverridePan(IntPtr channelgroup, float pan);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_OverrideMute(IntPtr channelgroup, int mute);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_OverrideReverbProperties(IntPtr channelgroup, ref REVERB_CHANNELPROPERTIES prop);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_Override3DAttributes(IntPtr channelgroup, ref VECTOR pos, ref VECTOR vel);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_OverrideSpeakerMix(IntPtr channelgroup, float frontleft, float frontright, float center, float lfe, float backleft, float backright, float sideleft, float sideright);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_AddGroup(IntPtr channelgroup, IntPtr group);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_GetNumGroups(IntPtr channelgroup, ref int numgroups);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_GetGroup(IntPtr channelgroup, int index, ref IntPtr group);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_GetParentGroup(IntPtr channelgroup, ref IntPtr group);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_GetDSPHead(IntPtr channelgroup, ref IntPtr dsp);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_AddDSP(IntPtr channelgroup, IntPtr dsp, ref IntPtr connection);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_GetName(IntPtr channelgroup, StringBuilder name, int namelen);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_GetNumChannels(IntPtr channelgroup, ref int numchannels);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_GetChannel(IntPtr channelgroup, int index, ref IntPtr channel);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_GetSpectrum(IntPtr channelgroup, [MarshalAs(UnmanagedType.LPArray)] float[] spectrumarray, int numvalues, int channeloffset, DSP_FFT_WINDOW windowtype);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_GetWaveData(IntPtr channelgroup, [MarshalAs(UnmanagedType.LPArray)] float[] wavearray, int numvalues, int channeloffset);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_SetUserData(IntPtr channelgroup, IntPtr userdata);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_GetUserData(IntPtr channelgroup, ref IntPtr userdata);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_ChannelGroup_GetMemoryInfo(IntPtr channelgroup, uint memorybits, uint event_memorybits, ref uint memoryused, ref MEMORY_USAGE_DETAILS memoryused_details);
        #endregion

        #region importfunctions
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_SoundGroup_Release(IntPtr soundgroup);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_SoundGroup_GetSystemObject(IntPtr soundgroup, ref IntPtr system);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_SoundGroup_SetMaxAudible(IntPtr soundgroup, int maxaudible);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_SoundGroup_GetMaxAudible(IntPtr soundgroup, ref int maxaudible);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_SoundGroup_SetMaxAudibleBehavior(IntPtr soundgroup, SOUNDGROUP_BEHAVIOR behavior);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_SoundGroup_GetMaxAudibleBehavior(IntPtr soundgroup, ref SOUNDGROUP_BEHAVIOR behavior);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_SoundGroup_SetMuteFadeSpeed(IntPtr soundgroup, float speed);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_SoundGroup_GetMuteFadeSpeed(IntPtr soundgroup, ref float speed);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_SoundGroup_SetVolume(IntPtr soundgroup, float volume);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_SoundGroup_GetVolume(IntPtr soundgroup, ref float volume);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_SoundGroup_Stop(IntPtr soundgroup);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_SoundGroup_GetName(IntPtr soundgroup, StringBuilder name, int namelen);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_SoundGroup_GetNumSounds(IntPtr soundgroup, ref int numsounds);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_SoundGroup_GetSound(IntPtr soundgroup, int index, ref IntPtr sound);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_SoundGroup_GetNumPlaying(IntPtr soundgroup, ref int numplaying);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_SoundGroup_SetUserData(IntPtr soundgroup, IntPtr userdata);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_SoundGroup_GetUserData(IntPtr soundgroup, ref IntPtr userdata);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_SoundGroup_GetMemoryInfo(IntPtr soundgroup, uint memorybits, uint event_memorybits, ref uint memoryused, ref MEMORY_USAGE_DETAILS memoryused_details);
        #endregion

        #region importfunctions

        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_Release(IntPtr dsp);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_GetSystemObject(IntPtr dsp, ref IntPtr system);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_AddInput(IntPtr dsp, IntPtr target, ref IntPtr connection);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_DisconnectFrom(IntPtr dsp, IntPtr target);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_DisconnectAll(IntPtr dsp, int inputs, int outputs);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_Remove(IntPtr dsp);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_GetNumInputs(IntPtr dsp, ref int numinputs);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_GetNumOutputs(IntPtr dsp, ref int numoutputs);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_GetInput(IntPtr dsp, int index, ref IntPtr input, ref IntPtr inputconnection);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_GetOutput(IntPtr dsp, int index, ref IntPtr output, ref IntPtr outputconnection);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_SetActive(IntPtr dsp, int active);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_GetActive(IntPtr dsp, ref int active);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_SetBypass(IntPtr dsp, int bypass);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_GetBypass(IntPtr dsp, ref int bypass);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_SetSpeakerActive(IntPtr dsp, SPEAKER speaker, int active);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_GetSpeakerActive(IntPtr dsp, SPEAKER speaker, ref int active);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_Reset(IntPtr dsp);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_SetParameter(IntPtr dsp, int index, float value);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_GetParameter(IntPtr dsp, int index, ref float value, StringBuilder valuestr, int valuestrlen);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_GetNumParameters(IntPtr dsp, ref int numparams);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_GetParameterInfo(IntPtr dsp, int index, StringBuilder name, StringBuilder label, StringBuilder description, int descriptionlen, ref float min, ref float max);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_ShowConfigDialog(IntPtr dsp, IntPtr hwnd, int show);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_GetInfo(IntPtr dsp, ref IntPtr name, ref uint version, ref int channels, ref int configwidth, ref int configheight);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_GetType(IntPtr dsp, ref DSP_TYPE type);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_SetDefaults(IntPtr dsp, float frequency, float volume, float pan, int priority);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_GetDefaults(IntPtr dsp, ref float frequency, ref float volume, ref float pan, ref int priority);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_SetUserData(IntPtr dsp, IntPtr userdata);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_GetUserData(IntPtr dsp, ref IntPtr userdata);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSP_GetMemoryInfo(IntPtr dsp, uint memorybits, uint event_memorybits, ref uint memoryused, ref MEMORY_USAGE_DETAILS memoryused_details);
        #endregion
        #region importfunctions

        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSPConnection_GetInput(IntPtr dspconnection, ref IntPtr input);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSPConnection_GetOutput(IntPtr dspconnection, ref IntPtr output);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSPConnection_SetMix(IntPtr dspconnection, float volume);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSPConnection_GetMix(IntPtr dspconnection, ref float volume);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSPConnection_SetLevels(IntPtr dspconnection, SPEAKER speaker, float[] levels, int numlevels);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSPConnection_GetLevels(IntPtr dspconnection, SPEAKER speaker, [MarshalAs(UnmanagedType.LPArray)]float[] levels, int numlevels);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSPConnection_SetUserData(IntPtr dspconnection, IntPtr userdata);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSPConnection_GetUserData(IntPtr dspconnection, ref IntPtr userdata);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_DSPConnection_GetMemoryInfo(IntPtr dspconnection, uint memorybits, uint event_memorybits, ref uint memoryused, ref MEMORY_USAGE_DETAILS memoryused_details);
        #endregion
        #region importfunctions
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Geometry_AddPolygon(IntPtr geometry, float directocclusion, float reverbocclusion, int doublesided, int numvertices, VECTOR[] vertices, ref int polygonindex);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Geometry_GetPolygonNumVertices(IntPtr geometry, int index, ref int numvertices);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Geometry_SetPolygonVertex(IntPtr geometry, int index, int vertexindex, ref VECTOR vertex);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Geometry_GetPolygonVertex(IntPtr geometry, int index, int vertexindex, ref VECTOR vertex);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Geometry_SetPolygonAttributes(IntPtr geometry, int index, float directocclusion, float reverbocclusion, int doublesided);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Geometry_GetPolygonAttributes(IntPtr geometry, int index, ref float directocclusion, ref float reverbocclusion, ref int doublesided);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Geometry_Flush(IntPtr geometry);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Geometry_SetActive(IntPtr geometry, int active);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Geometry_GetActive(IntPtr geometry, ref int active);
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern RESULT FMOD_Geometry_GetMemoryInfo(IntPtr geometry, uint memorybits, uint event_memorybits, ref uint memoryused, ref MEMORY_USAGE_DETAILS memoryused_details);
        #endregion
    }
}
